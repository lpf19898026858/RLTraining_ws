...
public:
    ...
    QLabel *v_uav_0_current_position_label_2;
    ...
    void setupUi(QMainWindow *v_uav_local_network)
    {
        ...
        v_uav_0_label->setGeometry(QRect(30, 10, 61, 51));
        ...
        v_uav_0_current_position_label->setGeometry(QRect(750, 40, 131, 31));
        ...
        v_uav_0_ref_nlp_command->setGeometry(QRect(60, 80, 501, 22));
        ...
        v_uav_0_send_command_button->setGeometry(QRect(590, 80, 80, 22));
        feedback_text_edit = new QPlainTextEdit(centralwidget);
        feedback_text_edit->setObjectName(QString::fromUtf8("feedback_text_edit"));
        feedback_text_edit->setGeometry(QRect(60, 120, 611, 311));
        v_uav_0_current_position_label_2 = new QLabel(centralwidget);
        v_uav_0_current_position_label_2->setObjectName(QString::fromUtf8("v_uav_0_current_position_label_2"));
        v_uav_0_current_position_label_2->setGeometry(QRect(140, 20, 131, 31));
        ...
        v_uav_0_mission_id_label_2->setGeometry(QRect(720, 90, 71, 20));
        ...
        v_uav_0_mission_id_label_3->setGeometry(QRect(720, 120, 71, 20));
        ...
        v_uav_0_mission_id_edit_2->setGeometry(QRect(810, 90, 81, 22));
        ...
        v_uav_0_mission_id_label_4->setGeometry(QRect(720, 150, 71, 20));
        ...
        v_uav_0_mission_id_edit_3->setGeometry(QRect(810, 120, 81, 22));
        ...
        v_uav_0_mission_id_edit_4->setGeometry(QRect(810, 150, 81, 22));
    ...
    void retranslateUi(QMainWindow *v_uav_local_network)
    {
        ...
        v_uav_0_current_position_label_2->setText(QApplication::translate("v_uav_local_network", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Current Position</span></p></body></html>", nullptr));
