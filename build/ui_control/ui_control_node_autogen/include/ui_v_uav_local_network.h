...
public:
    ...
    void setupUi(QMainWindow *v_uav_local_network)
    {
        ...
        v_uav_0_current_position_label->setGeometry(QRect(740, 140, 131, 31));
        ...
        v_uav_0_mission_id_label_3->setGeometry(QRect(710, 220, 71, 20));
        ...
        v_uav_0_mission_id_edit_2->setGeometry(QRect(800, 190, 81, 22));
        ...
        v_uav_0_mission_id_label_4->setGeometry(QRect(710, 250, 71, 20));
        ...
        v_uav_0_mission_id_edit_3->setGeometry(QRect(800, 220, 81, 22));
        ...
        v_uav_0_mission_id_edit_4->setGeometry(QRect(800, 250, 81, 22));
